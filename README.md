...
```bash
git clone https://github.com/Nizam Mohammed/AirBnB_clone.git
```
...
## Authors
<details>
    <summary>Nizam Mohammed</summary>
    <ul>
    <li><a href="mailto:nizameshetu@gmail.com">e-mail</a></li>
    </ul>
</details>
<details>
    <summary> Emediong Effiong</summary>
    <ul>
    <li><a href="mailto:gideoneffiong09@gmail.com">e-mail</a></li>
    </ul>
</details>
